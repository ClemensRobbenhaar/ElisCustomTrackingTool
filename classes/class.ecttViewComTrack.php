...
class ecttViewComTrack
{
	...
	public function getInvolvedObjects()
	{
		...
		{
			$this->involved_objects[$obj_type] = ilElisCustomTrackingToolPlugin::_getInstance()->txt('ectt_obj_type_'.$obj_type);
		}
	...
	public function getInvolvedComTypes()
	{
		...
		{
			$this->involved_com_types[$com_type] = ilElisCustomTrackingToolPlugin::_getInstance()->txt('ectt_com_type_'.$com_type);
		}
